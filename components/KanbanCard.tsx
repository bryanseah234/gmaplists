...
export const KanbanCard: React.FC<KanbanCardProps> = ({ place, columnId }) => {
  ...
  return (
    ...
    >
      ...
      <div
        {...listeners}
        {...attributes}
        className="mt-0.5 flex-shrink-0 text-zinc-300 dark:text-zinc-700 hover:text-zinc-500 dark:hover:text-zinc-400 cursor-grab active:cursor-grabbing"
        title="Drag to move"
      >
