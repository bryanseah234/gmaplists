            ...
            <div className="grid gap-2 p-2">
              {items.map((place) => {
                ...
                <article
                  ...
                  className="grid gap-3 rounded-lg border border-zinc-200 bg-zinc-50 p-3 md:grid-cols-[minmax(0,1fr)_260px] md:items-start dark:border-zinc-800 dark:bg-zinc-950"
                >
